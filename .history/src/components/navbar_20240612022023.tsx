      ...
      <header className="navbar1-container">
        <header data-thq="thq-navbar" className="navbar1-navbar-interactive">
          ...
          <div data-thq="thq-navbar-nav" className="navbar1-desktop-menu">
            <nav className="navbar1-links flex gap-4">
            ...
            <div className="navbar1-buttons flex gap-4">
          ...
          <div
            ...
            className="navbar1-burger-menu hidden md:flex items-center justify-center"
          >
            <svg viewBox="0 0 1024 1024" className="navbar1-icon w-6 h-6">
          ...
          <div data-thq="thq-mobile-menu" className="navbar1-mobile-menu">
            <div className="navbar1-nav">
              <div className="navbar1-top flex items-center justify-between mb-4">
                <img
                  alt={props.logoAlt}
                  src={props.logoSrc}
                  className="navbar1-logo h-12"
                />
                <div data-thq="thq-close-menu" className="navbar1-close-menu">
                  <svg
                    viewBox="0 0 1024 1024"
                    className="navbar1-icon02 w-6 h-6"
                  >
                    <path d="M810 274l-238 238 238 238-60 60-238-238-238 238-60-60 238-238-238-238 60-60 238 238 238-238z"></path>
                  </svg>
                </div>
              </div>
              <nav className="navbar1-links1 flex flex-col gap-2">
