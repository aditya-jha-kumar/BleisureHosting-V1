...
//   return (
//     <div className="w-full h-auto relative bg-white rounded-lg shadow-md overflow-hidden group my-8">
//       {/* Image */}
...
const Card = ({ imageSrc, largeText, smallText }: CardProps) => {
  return (
    <div className="w-full h-auto relative rounded-lg shadow-md overflow-hidden group my-8 ">
      {/* Image */}
      <div className="relative">
        <img src={imageSrc} alt="Card" className="w-full h-auto" />
        {/* Black overlay */}
        <div className="absolute inset-0 bg-black opacity-50 bottom-0 left-0 p-4"></div>
      </div>
