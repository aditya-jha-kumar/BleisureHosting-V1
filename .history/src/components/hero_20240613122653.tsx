...
const Hero = ({ smallText, largeText, backgroundImage }: HeroProps) => {
  return (
    <div className="relative w-full h-96 mx-5 ">
      <div
        className="absolute inset-0 bg-cover bg-center mx-10 "
        style={{
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white bg-white">
