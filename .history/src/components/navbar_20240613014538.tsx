...
const Navbar = ({
  ...
  return (
    <nav className="bg-white dark:bg-white fixed w-full z-20 top-0 border-b">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-2 md:py-4 flex items-center justify-between">
          ...
          <ul className="flex flex-col md:flex-row p-2 md:p-0 mt-2 md:mt-0 font-medium border-t border-gray-200 md:border-none bg-white md:bg-transparent md:space-x-4 rtl:space-x-reverse">
            ...
            <li>
              <button
                ...
                aria-label={option4}
              >
                <RiContactsLine className="w-6 h-6" />
            ...
            <li>
              ...
              >
                <span className="nav-text hidden md:inline">Become a partner</span>
              </button>
            </li>
            <li>
              <button
                ...
                aria-label="Sign up"
              >
                <span className="nav-text hidden md:inline">Sign up</span>
              </button>
            </li>
          </ul>
        </div>
