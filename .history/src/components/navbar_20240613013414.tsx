    ...
    <nav className="bg-white dark:bg-white fixed w-full z-20 top-0 border-b">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <button
            type="button"
            className="text-white bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:focus:ring-blue-800 transition duration-300 ease-in-out hover:bg-blue-800 hover:border-blue-800"
          >
            {button2Label}
          </button>
          <button
        ...
        >
          <ul className="flex flex-col md:flex-row p-4 md:p-0 mt-4 font-medium border-t border-gray-200 md:border-none bg-white md:bg-transparent md:space-x-8 rtl:space-x-reverse">
            <li>
              <button className="nav-link hover:text-blue-700" aria-label={option1}>
                <span className="nav-text">{option1}</span>
              </button>
            </li>
            <li>
              <button className="nav-link hover:text-blue-700" aria-label={option2}>
                <span className="nav-text">{option2}</span>
              </button>
            </li>
            <li>
              <button className="nav-link hover:text-blue-700" aria-label={option3}>
                <span className="nav-text">{option3}</span>
              </button>
            </li>
            <li>
              <button className="nav-link hover:text-blue-700" aria-label={option4}>
