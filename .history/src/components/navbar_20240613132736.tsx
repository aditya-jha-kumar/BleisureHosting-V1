    ...
    <nav className={`bg-white dark:bg-white z-10 top-0 w-full ${className}`}>
      <div className="mx-auto px-4 md:px-8 py-2 md:py-4 flex items-center justify-between max-w-full">
        <div className="flex items-center space-x-3 rtl:space-x-reverse cursor-pointer">
          ...
          <span className="text-base md:text-2xl font-semibold whitespace-nowrap dark:text-black">
            {logoAlt}
          </span>
        </div>
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button
            type="button"
            className="text-xs md:text-sm text-black bg-white border-black border-2 focus:ring-4 font-medium rounded-lg px-2 md:px-4 py-1 md:py-2 text-center transition duration-300 ease-in-out hover:bg-black hover:text-white hover:border-gray-800"
          >
            {button1Label}
          </button>
          <button
            type="button"
            className="text-xs md:text-sm text-white bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-2 md:px-4 py-1 md:py-2 text-center dark:bg-blue-600 dark:focus:ring-blue-800 transition duration-300 ease-in-out hover:bg-blue-800 hover:border-blue-800"
          >
            {button2Label}
          </button>
          <button
        ...
        >
          <ul className="flex flex-col md:flex-row p-2 md:p-0 mt-2 md:mt-0 font-medium border-t border-gray-200 md:border-none bg-white md:bg-transparent md:space-x-4 rtl:space-x-reverse">
            <li>
              <button
                className="nav-link flex items-center space-x-2 md:space-x-0 text-sm md:text-base hover:text-blue-700"
                aria-label={option1}
              >
                <RiHome4Line className="block md:hidden" />
            ...
            <li>
              <button
                ...
                aria-label={option2}
              >
                <RiInformationLine className="block md:hidden" />
            ...
            <li>
              <button
                ...
                aria-label={option3}
              >
                <RiBriefcase4Line className="block md:hidden" />
            ...
            <li>
              <button
                ...
                aria-label={option4}
              >
                <RiContactsLine className="block md:hidden" />
