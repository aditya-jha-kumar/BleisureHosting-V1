    ...
    <div className={`relative w-full ${className}`}>
      <div
        ...
        style={{
          ...
          filter: "blur(8px)", // Add blur effect to the background image
        }}
      />
      <div className="absolute inset-0 bg-black opacity-50" />
      <div className="mx-4 absolute inset-0 flex flex-col items-center justify-center text-white">
        <div className="text-sm">{smallText}</div>
        <div className="text-3xl font-bold">{largeText}</div>
      </div>
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 w-full max-w-3xl mx-auto">
