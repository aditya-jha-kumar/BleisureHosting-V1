...
const Hero = ({
  ...
  return (
    <div className={`relative w-full mx-auto max-w-screen-xl ${className}`}>
      <div
      ...
      <div className="mx-4 absolute inset-0 flex flex-col items-center justify-center text-white z-20">
        <div className="text-sm">{smallText}</div>
        <div className="text-3xl font-bold">{largeText}</div>
      </div>
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 w-full max-w-3xl z-20">
