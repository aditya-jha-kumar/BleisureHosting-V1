  ...
  return (
    <footer className="bg-white dark:bg-gray-900 w-full">
      <div className="mx-auto max-w-screen-xl px-4 py-6 lg:py-8">
        <h1 className="text-3xl font-bold text-blue-600 text-center mb-6">Bleisure</h1>
        ...
        <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 text-center">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center block mb-4">
            © 2024 <Link href="https://flowbite.com/">Bleisure™</Link>. All Rights Reserved.
          </span>
