...
export default function Home() {
  const logos = [
    { id: "logo2", src: "/componentlogo2.png", alt: "Brand 2" },
    { id: "logo3", src: "/componentlogo3.png", alt: "Brand 3" },
    { id: "logo4", src: "/componentlogo4.png", alt: "Brand 4" },
    { id: "logo1", src: "/componentlogo1.png", alt: "Brand 1" },
