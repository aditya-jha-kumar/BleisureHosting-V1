...
export default function Home() {
  const logos = [
    { id: "logo2", src: "/logos/logo2.png", alt: "Brand 2" },
    { id: "logo3", src: "/logos/logo3.png", alt: "Brand 3" },
    { id: "logo1", src: "/logos/logo1.png", alt: "Brand 1" },
    { id: "logo4", src: "/logos/logo4.png", alt: "Brand 4" },
