...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center">
      ...
      {/* Revolutionizing */}
      <div className="flex flex-nowwrap overflow-x-auto items-center justify-center text-center mt-8 md:mt-12 px-4">
        <h1 className="text-3xl font-bold">
          How We Are Revolutionizing <br /> the Rental Game
        </h1>
        <div className="flex flex-wrap justify-center mt-8 space-x-4 md:space-x-8">
          <Card2 imageSrc="/a1.png" largeText="abcac" smallText="acac" />
          <Card2 imageSrc="/a2.png" largeText="acacac" smallText="acacea" />
          <Card2 imageSrc="/a3.png" largeText="acaecae" smallText="acaecae" />
          <Card2 imageSrc="/a4.png" largeText="acac" smallText="acacaecaec" />
        </div>
      </div>
    </div>
  );
