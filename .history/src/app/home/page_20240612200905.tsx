...
export default function Home() {
  const logos = [
    { id: "logo2", src: "/compo/logo2.png", alt: "Brand 2" },
    { id: "logo3", src: "/compo/logo3.png", alt: "Brand 3" },
    { id: "logo4", src: "/compo/logo4.png", alt: "Brand 4" },
    { id: "logo1", src: "/compo/logo1.png", alt: "Brand 1" },
