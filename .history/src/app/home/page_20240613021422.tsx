...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-wh">
      {/* Navbar */}
      <div className="min-h-screen flex flex-col justify-center items-center relative w-full mb-5">
        {/* Navbar */}
        <Navbar
          logoSrc="/logo.png"
          logoAlt=""
          ...
          className="z-10" // Ensure Navbar stays on top
        />
        ...
        <Hero
          ...
          className="rounded z-0 overflow-hidden mt-5" // Set lower z-index to push it below the Navbar
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <p className="text-white mt-20 text-lg">Simple - Unique - Friendly</p>
          <h1 className="text-white text-3xl lg:text-5xl font-bold mb-4 text-center">
