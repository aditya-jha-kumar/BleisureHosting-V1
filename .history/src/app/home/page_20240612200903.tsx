...
export default function Home() {
  const logos = [
    { id: "logo2", src: "/logo/logo2.png", alt: "Brand 2" },
    { id: "logo3", src: "/logo/logo3.png", alt: "Brand 3" },
    { id: "logo4", src: "/logo/logo4.png", alt: "Brand 4" },
    { id: "logo1", src: "/logo/logo1.png", alt: "Brand 1" },
