...
export default function Home() {
  const logos = [
    { id: "logo2", src: "/components/logo2.png", alt: "Brand 2" },
    { id: "logo3", src: "/components/logo3.png", alt: "Brand 3" },
    { id: "logo4", src: "/components/logo4.png", alt: "Brand 4" },
    { id: "logo1", src: "/components/logo1.png", alt: "Brand 1" },
