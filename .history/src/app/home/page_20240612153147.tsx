...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="flex flex-column justify-center mt-8 space-x-4 md:space-x-8">
        <Card2 imageSrc="/card1.png" largeText="abcac" smallText="acac" />
        ...
        <Card imageSrc="/a4.png" largeText="acac" smallText="acacaecaec" />
      </div>
      <div>
        <h1>lagnlafnakf</h1>
      </div>
