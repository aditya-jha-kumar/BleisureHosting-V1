...
const Hero: React.FC<HeroProps> = ({ smallText, largeText, backgroundImage, left, className }) => {
  return (
    <div className={`relative w-full h-96 ${className}`}>
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{ backgroundImage: `url(${backgroundImage})`, backgroundColor: "rgba(0, 0, 0, 0.5)" }}
      />
      ...
      <div className={`absolute bottom-0 left-${left} transform -translate-x-1/2 translate-y-1/2 w-full max-w-3xl`}>
