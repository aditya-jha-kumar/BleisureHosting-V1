    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-white">
      ...
      <div className="min-h-screen flex flex-col justify-center items-center relative w-full mb-5">
        ...
        <Navbar
          ...
          className="fixed top-0 left-0 right-0 z-50" // Ensure Navbar stays on top
        />

        {/* Hero section */}
        <Hero
          smallText="Welcome to Our Service"
          largeText="Find Your Perfect Stay"
          backgroundImage="/hero.png"
          className="border-black mx-4 md:mx-20" // Add margins directly to the Hero component
        />
