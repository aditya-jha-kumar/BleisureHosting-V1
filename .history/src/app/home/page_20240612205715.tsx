  ...
  const reviews = [
    {
      ...
      review: "This place was amazing! The host was very accommodating and the location was perfect.",
    },
    {
      ...
      review: "Great place to stay. The apartment was clean and well-equipped. Would recommend!",
    },
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="flex justify-center mt-8 space-x-4 md:space-x-8">
        <Card2
          imageSrc="/card4.png"
          largeText="Stylish & Affordable"
          smallText="Viman Nagar, Pune"
        />
        <Card2
          imageSrc="/card5.png"
          largeText="Modern Comfort"
          smallText="Viman Nagar, Pune"
        />
        <Card2
          imageSrc="/card6.png"
          largeText="Prime Location"
          smallText="Viman Nagar, Pune"
        />
      </div>
